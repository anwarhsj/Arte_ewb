        ...
        try:
            ...
            if data and "objectIDs" in data:
                ...
                if valid_art:
                    ...
                    # Save current painting and details to history
                    ...
                    # Display current art piece (اللوحة الحالية المكتشفة تظهر بصورتها كالمعتاد)
...
if st.session_state.art_history:
    for idx, item in enumerate(st.session_state.art_history):
        # يظهر في السجل فقط اسم اللوحة واسم الفنان، وعند فتحه يظهر الوصف المكتوب دون الصورة
